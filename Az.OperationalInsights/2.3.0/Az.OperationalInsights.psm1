...
#
# Generated on: 07/16/2020 09:09:45
#
...
$FilteredCommands = @('Get-AzOperationalInsightsSavedSearch:ResourceGroupName','Get-AzOperationalInsightsSchema:ResourceGroupName','New-AzOperationalInsightsComputerGroup:ResourceGroupName','New-AzOperationalInsightsSavedSearch:ResourceGroupName','Remove-AzOperationalInsightsSavedSearch:ResourceGroupName','Set-AzOperationalInsightsSavedSearch:ResourceGroupName','Get-AzOperationalInsightsIntelligencePack:ResourceGroupName','Get-AzOperationalInsightsLinkedStorageAccount:ResourceGroupName','Get-AzOperationalInsightsWorkspaceManagementGroup:ResourceGroupName','Get-AzOperationalInsightsWorkspaceSharedKey:ResourceGroupName','Get-AzOperationalInsightsWorkspaceUsage:ResourceGroupName','New-AzOperationalInsightsLinkedStorageAccount:ResourceGroupName','New-AzOperationalInsightsWorkspace:ResourceGroupName','Remove-AzOperationalInsightsLinkedStorageAccount:ResourceGroupName','Remove-AzOperationalInsightsWorkspace:ResourceGroupName','Restore-AzOperationalInsightsWorkspace:ResourceGroupName','Set-AzOperationalInsightsIntelligencePack:ResourceGroupName','Set-AzOperationalInsightsLinkedStorageAccount:ResourceGroupName','Get-AzOperationalInsightsLinkedService:ResourceGroupName','New-AzOperationalInsightsCluster:ResourceGroupName','Remove-AzOperationalInsightsCluster:ResourceGroupName','Update-AzOperationalInsightsCluster:ResourceGroupName','Remove-AzOperationalInsightsLinkedService:ResourceGroupName','Set-AzOperationalInsightsLinkedService:ResourceGroupName')
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAc2ZHngZ+X61Yi
# gc0BmUCnrds69sH7jgGLNHhE+qgIq6CCDYEwggX/MIID56ADAgECAhMzAAABh3IX
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgM8ZVm1fv
# lDD3r0khP1FmvuU0PtE6TPpCvjXEihls7g4wQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQBISrsmWUakxPK54cN827bMDWfCTeNQtyVVMkLgfXUC
# U5kg2RsrnkFT85mPhIvACvfUHGnbCViuC95Nv1ozaYNyW0Ei45GFSSxX6o5RndPp
# gPxTwD4ggmDN0W9mH22goJTvPESFNR/AdUcvNLLjXh/FLhGJpXLBri7IKRfBTi/F
# KLi8LT0nGjB+s1TEIXO3tY4PcS29ta2G+ObkyfLdQVMwXPJ8/GiWnRVxihr13/AZ
# DwUc08FIi45V6BnXI/VmCHdIPme7iGNo8pDvHmJWW9f7pkTu8znKl7uHSYuBt5dr
# 4Cl0Lg3ZYR7PcloFt23i1chkgIhvq6HS3dcCPj4fIs+boYIS5TCCEuEGCisGAQQB
# gjcDAwExghLRMIISzQYJKoZIhvcNAQcCoIISvjCCEroCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIKmA9YKzknP4AaYm1TZMHUo3Ocs/V9JYd5/l3jz6
# rgQdAgZe8L3Y83QYEzIwMjAwNzE2MDkzNTE1Ljg5N1owBIACAfSggdCkgc0wgcox
...
# VGltZS1TdGFtcCBQQ0EgMjAxMDANBgkqhkiG9w0BAQUFAAIFAOK6Nr8wIhgPMjAy
# MDA3MTYxMDE1MjdaGA8yMDIwMDcxNzEwMTUyN1owdzA9BgorBgEEAYRZCgQBMS8w
# LTAKAgUA4ro2vwIBADAKAgEAAgInWAIB/zAHAgEAAgIRqzAKAgUA4ruIPwIBADA2
# BgorBgEEAYRZCgQCMSgwJjAMBgorBgEEAYRZCgMCoAowCAIBAAIDB6EgoQowCAIB
# AAIDAYagMA0GCSqGSIb3DQEBBQUAA4GBACmUHLqWGDMe4utNvu076C8ccBLZGUbi
# arj0Pb6IFNQLV8u+5BpjazklOkyUz8KCoLNqH1LrRdvErdNcxuzXD3R6hya6vOtf
# Hnd27M9f7r+H1VZJojh36wSiSDmnMOB8b+pWmMbGQ2u9aP6/s4UyBaWVjRNkY+su
# gy6pBMNYSp1wMYIDDTCCAwkCAQEwgZMwfDELMAkGA1UEBhMCVVMxEzARBgNVBAgT
# Cldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29m
# dCBDb3Jwb3JhdGlvbjEmMCQGA1UEAxMdTWljcm9zb2Z0IFRpbWUtU3RhbXAgUENB
# IDIwMTACEzMAAAEY/jr32RvUsTMAAAAAARgwDQYJYIZIAWUDBAIBBQCgggFKMBoG
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgJy8nmMbx
# axOUUICbylAJ2YuoZVMNCr6A9Ntbj2tW1KEwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# AAEYMCIEIDIEWKOGjLygfElLajkVFY7GTWHxNE4nNq+iqOjc075OMA0GCSqGSIb3
# DQEBCwUABIIBAGdUQM+hnqVmS4ALunRhH86uOgXWBz2Der7VnEk49KXp2t3X8h0Y
# 1Dh6v7GXbGtgDcSGZ5eCVaoRBtL4Jl7zTC/za7KtwdSsnY162jh6Zfm/0gGLc2BT
# YGKUPl6YHu0901mhvJsEFskQPFApjawbUobtJfoukAJg8bWMDTQKtVRacAeTk1bg
# 3B5xdp/58fO2Ct1InXHXgCiL3bCnifzgQAeQaRQQOxQTRxL7lxovtyireFRimGXa
# reIm7tNXXrZkJvcWq91m0v30liUOnGin4hV4/tVJ6pEkWFUlVtMeQja0cj2sDOwy
# m/WS1bSjbpRI/1Ni1eXObG45P7s1gfk5OT4=
